...
import { Plus, Trash2, Shield, AlertCircle, Users } from "lucide-react";
...
const roleLabel = (member) => {
    if (member.is_superuser) return "Super-admin";
...
const SettingsAdminsManager = () => {
    ...
    const handleCreate = async (e) => {
        ...
        if (result.ok) {
            setForm({ email: "", phone: "", password: "", role: "staff" });
            setIsAdding(false);
        } else {
    ...
    if (loading) {
        return (
            <div className="text-xs font-poppins text-neutral-6 py-4">
                Chargement...
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <p className="text-[11px] font-poppins text-neutral-6 leading-relaxed">
                Les membres <strong>Staff</strong> se connectent à l&apos;admin mais
                n&apos;ont pas accès au Dashboard ni à cette page Équipe.
            </p>
                    ...
                    <form onSubmit={handleCreate} className="flex flex-col gap-4">
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-5 hover:text-neutral-7 transition-colors"
                                tabIndex={-1}
                            >
                        ...
                        {isSuperAdmin && (
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs font-poppins text-neutral-7">
                                    Rôle
                                </label>
                                <select
                                    name="role"
                                    value={form.role}
                                    onChange={handleChange}
                                    className="w-full rounded-2 border border-neutral-4 bg-neutral-0 px-3 py-2 text-xs font-poppins text-neutral-8"
                                >
                                    <option value="staff">Staff (sans dashboard / équipe)</option>
            ...
            <div className="flex flex-col divide-y divide-neutral-4 dark:divide-neutral-4 border border-neutral-4 dark:border-neutral-4 rounded-2 overflow-hidden">
                {admins.length === 0 ? (
                    <div className="p-8 text-center">
                        <Users size={28} className="mx-auto mb-2 text-neutral-5" />
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-1.5 mt-0.5">
                                        ...
                                        <span
                                            className={`px-1.5 py-0.5 rounded-full text-[10px] font-semibold font-poppins ${
                                                admin.role === "staff"
